<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="istatistik.aspx.cs" Inherits="CVENTITY.admin.istatistik" %>
   ...
   <div style="margin-left:20px; margin-right:20px"> 
    ...
    <div class="total-world">
        ...
        <div class="site-report">
            ...
            <p>Blog Sitesinin Admin paneli kısmındasınız</p>
        </div>
        <div class="clearfix"></div>
    </div>
